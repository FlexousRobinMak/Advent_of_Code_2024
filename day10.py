...
class TopoMap:
    ...
    def check_next(self,loc):
        ...
        for dir_check in self.dir_all:
            ...
            if ((loc_val == next_val-1) and
                 0 <= next_loc[0] <= self.map.shape[0] - 1 and
    ...
    def get_sol(self):
        ...
        self.opt_temp = set(self.opt_temp)
        sol = self.opt_temp
        print(sol)
        return sol
...
class Day10:
    ...
    def part1(self):
        ...
        self.x = topomap
        self.ans = topomap.get_sol()
        print(topomap.opt_temp)
